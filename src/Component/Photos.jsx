...
const images = [
    ...
    { src:require("../assets/images/TOKR9743.jpg"), alt: "Image 1", className: "col-span-2 row-span-2 imgheightclass" },
    
    { src:require("../assets/images/1V9A8666.jpg"), alt: "Image 2", className:"smallimage"},
    { src: require("../assets/images/1V9A8734.jpg"), alt: "Image 3", className:"smallimage" },
    ...
    { src: require("../assets/images/ANG_7087.jpg"), alt: "Image 9" , className:"smallimage"},
];
